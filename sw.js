const APP_CACHE = 'psk-transport-app-v6.7.6';
const DATA_CACHE = 'psk-transport-data-v6.7.6';

const APP_SHELL = [
  './',
  './index.html',
  './assets/styles.css?v=6.7.6',
  './assets/app.js?v=6.7.6',
  './manifest.webmanifest?v=6.7.6'
];
